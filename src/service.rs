...
//! Source: `Interface '/org/freedesktop/systemd1/unit/container_40snepcraft_2eservice' from service 'org.freedesktop.systemd1' on system bus`.
//!
...
pub trait Service {
    ...
    /// RemoveSubgroup method
    fn remove_subgroup(&self, subcgroup: &str, flags: u64) -> zbus::Result<()>;
    ...
    /// BPFDelegateAttachments property
    #[zbus(property, name = "BPFDelegateAttachments")]
    fn bpfdelegate_attachments(&self) -> zbus::Result<String>;

    /// BPFDelegateCommands property
    #[zbus(property, name = "BPFDelegateCommands")]
    fn bpfdelegate_commands(&self) -> zbus::Result<String>;

    /// BPFDelegateMaps property
    #[zbus(property, name = "BPFDelegateMaps")]
    fn bpfdelegate_maps(&self) -> zbus::Result<String>;

    /// BPFDelegatePrograms property
    #[zbus(property, name = "BPFDelegatePrograms")]
    fn bpfdelegate_programs(&self) -> zbus::Result<String>;

    /// BPFProgram property
    #[zbus(property, name = "BPFProgram")]
    fn bpfprogram(&self) -> zbus::Result<Vec<(String, String)>>;

    /// BindLogSockets property
    #[zbus(property)]
    fn bind_log_sockets(&self) -> zbus::Result<bool>;
    ...
    /// CacheDirectoryAccounting property
    #[zbus(property)]
    fn cache_directory_accounting(&self) -> zbus::Result<bool>;

    /// CacheDirectoryMode property
    #[zbus(property)]
    fn cache_directory_mode(&self) -> zbus::Result<u32>;

    /// CacheDirectoryQuota property
    #[zbus(property)]
    fn cache_directory_quota(&self) -> zbus::Result<(u64, u32, String)>;

    /// CacheDirectoryQuotaUsage property
    #[zbus(property)]
    fn cache_directory_quota_usage(&self) -> zbus::Result<(u64, u64)>;
    ...
    /// DelegateNamespaces property
    #[zbus(property)]
    fn delegate_namespaces(&self) -> zbus::Result<u64>;
    ...
    /// ExtraFileDescriptorNames property
    #[zbus(property)]
    fn extra_file_descriptor_names(&self) -> zbus::Result<Vec<String>>;
    ...
    /// ImportCredentialEx property
    #[zbus(property)]
    fn import_credential_ex(&self) -> zbus::Result<Vec<(String, String)>>;
    ...
    /// LiveMountResult property
    #[zbus(property)]
    fn live_mount_result(&self) -> zbus::Result<String>;
    ...
    /// LogsDirectoryAccounting property
    #[zbus(property)]
    fn logs_directory_accounting(&self) -> zbus::Result<bool>;

    /// LogsDirectoryMode property
    #[zbus(property)]
    fn logs_directory_mode(&self) -> zbus::Result<u32>;

    /// LogsDirectoryQuota property
    #[zbus(property)]
    fn logs_directory_quota(&self) -> zbus::Result<(u64, u32, String)>;

    /// LogsDirectoryQuotaUsage property
    #[zbus(property)]
    fn logs_directory_quota_usage(&self) -> zbus::Result<(u64, u64)>;
    ...
    /// ManagedOOMMemoryPressureDurationUSec property
    #[zbus(property, name = "ManagedOOMMemoryPressureDurationUSec")]
    fn managed_oommemory_pressure_duration_usec(&self) -> zbus::Result<u64>;
    ...
    /// PrivateBPF property
    #[zbus(property, name = "PrivateBPF")]
    fn private_bpf(&self) -> zbus::Result<String>;
    ...
    /// PrivatePIDs property
    #[zbus(property, name = "PrivatePIDs")]
    fn private_pids(&self) -> zbus::Result<String>;

    /// PrivateTmp property
    #[zbus(property)]
    fn private_tmp(&self) -> zbus::Result<bool>;

    /// PrivateTmpEx property
    #[zbus(property)]
    fn private_tmp_ex(&self) -> zbus::Result<String>;

    /// PrivateUsers property
    #[zbus(property)]
    fn private_users(&self) -> zbus::Result<bool>;

    /// PrivateUsersEx property
    #[zbus(property)]
    fn private_users_ex(&self) -> zbus::Result<String>;
    ...
    /// ProtectControlGroupsEx property
    #[zbus(property)]
    fn protect_control_groups_ex(&self) -> zbus::Result<String>;
    ...
    /// ProtectHostnameEx property
    #[zbus(property)]
    fn protect_hostname_ex(&self) -> zbus::Result<(String, String)>;
    ...
    /// StateDirectoryAccounting property
    #[zbus(property)]
    fn state_directory_accounting(&self) -> zbus::Result<bool>;

    /// StateDirectoryMode property
    #[zbus(property)]
    fn state_directory_mode(&self) -> zbus::Result<u32>;

    /// StateDirectoryQuota property
    #[zbus(property)]
    fn state_directory_quota(&self) -> zbus::Result<(u64, u32, String)>;

    /// StateDirectoryQuotaUsage property
    #[zbus(property)]
    fn state_directory_quota_usage(&self) -> zbus::Result<(u64, u64)>;

    /// StateDirectorySymlink property
    #[zbus(property)]
    fn state_directory_symlink(&self) -> zbus::Result<Vec<(String, String, u64)>>;

    /// StatusBusError property
    #[zbus(property)]
    fn status_bus_error(&self) -> zbus::Result<String>;
    ...
    /// StatusVarlinkError property
    #[zbus(property)]
    fn status_varlink_error(&self) -> zbus::Result<String>;
