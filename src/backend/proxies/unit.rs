...
pub trait Unit {
    ...
    /// KillSubgroup method
    fn kill_subgroup(&self, subgroup: &str, signal: i32) -> zbus::Result<()>;
    ...
    /// CanLiveMount property
    #[zbus(property)]
    fn can_live_mount(&self) -> zbus::Result<bool>;
    ...
    /// DebugInvocation property
    #[zbus(property)]
    fn debug_invocation(&self) -> zbus::Result<bool>;
