...
pub trait Manager {
    ...
    /// DefaultRestrictSUIDSGID property
    #[zbus(property, name = "DefaultRestrictSUIDSGID")]
    fn default_restrict_suidsgid(&self) -> zbus::Result<bool>;
